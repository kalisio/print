...
module.exports = configure(function (ctx) {
  return {
    ...
    htmlVariables: {
      ...
      appDescription: 'Kalisio print Application'
    },
    ...
    pwa: {
      ...
      manifest: {
        name: pwaName,
        short_name: pwaName,
        description: `Kalisio print Application`,
        display: 'standalone',
        start_url: 'https://print.dev.kalisio.xyz',
        id: 'print',
        orientation: 'portrait',
        icons: [
          {
            src: 'print-icon-color-64x64.png',
            sizes: '64x64',
            type: 'image/png'
          },
          {
            src: 'print-icon-color-128x128.png',
            sizes: '128x128',
            type: 'image/png'
          },
          {
            src: 'print-icon-color-256x256.png',
            sizes: '256x256',
            type: 'image/png'
          },
          {
            src: 'print-icon-color-512x512.png',
            sizes: '512x512',
            type: 'image/png'
          }
        ]
